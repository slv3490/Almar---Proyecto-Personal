...
class RoleSeeder extends Seeder
{
    ...
    {
        //Spectator
        $userSpectatorRole = Role::create(["name" => "spectator"]);
        $permission_user_spectator = Permission::create(["name" => "spectator"]);
        ...
        $userSpectatorRole->givePermissionTo($permission_user_spectator);
        $role_admin->syncPermissions($permissions_admin);
        $role_editor->syncPermissions($permissions_editor);
        $role_editor->givePermissionTo($permission_user);
