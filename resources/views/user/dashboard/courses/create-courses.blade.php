...
<div class="contenedor dashboard">
    ...
    <section>
        ...
        <div class="container-divs">
            ...
            <div class="div-right">
                <form method="POST" action="{{ route('store-courses') }}" class="formulario courses-form" enctype="multipart/form-data">
                    @csrf
                    @method("POST")
                    ...
                    <div>
                        ...
                        <div class="campo">
                            ...
                            <input type="number" id="price" placeholder="Ej: 77.99" name="price" value="{{ old("price") }}">
                        </div>
                        ...
                        <div class="campo">
                            ...
                            <div class="categoryOptions">
                                ...
                                <input id="category_lesson" type="hidden" name="category_id">
                    ...
                    <input type="{{ Auth::user()->hasPermissionTo('spectator') ? 'button' : 'submit' }}" value="Crear Curso" class="boton {{ Auth::user()->hasPermissionTo('spectator') ? 'disabled' : '' }}" id="createCourse">
                </form>
            </div>
        </div>
    </section>
